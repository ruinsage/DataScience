...
def search_visitor(check_name):
    with open("D:\\Pywork\\DataScience\\PythonBasic\\Chapter08\\data\\방명록.txt","r",encoding="UTF-8") as file:
        visitor = file.read()
...
if is_visit :
    ...
    with open("D:\\Pywork\\DataScience\\PythonBasic\\Chapter08\\data\\방명록.txt",'a',encoding='UTF-8') as file:
        file.write(f"\n{name} {birthday}")
